    ...
    fs.createReadStream(filePath)
      ...
      .on('data', (row) => {
        ...
        if (deviceName && model) {
          ...
          rawEvents.push({ deviceName, model, manufacturer, eventType, description: deviceProblem, patientProblem, reportDate, eventText, severity });
        }
      })
      .on('end', async () => {
